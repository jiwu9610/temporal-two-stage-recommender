"""Shared constants for the anchor run scripts.
...
Holds the paths, the leg E gate band, and the two methodology disclosures
recorded next to the results, plus the writer that
...
# Leg E gate: official-benchmark SASRec
...
# ---- Methodology disclosures recorded beside the results ---------------------

MEMO_SELECTION_ASYMMETRY = (
    "SELECTION ASYMMETRY: the two-tower leg D "
...
MEMO_LIFETIME_ITEM_FEATURES = (
    "LIFETIME-CATALOG AGGREGATES: leg D's "
...
SEEN_MASK_CONVENTIONS = {
    ...
    "two_tower_dump": (
        ...
        "general-model convention (identical metrics after seen-removal)."
    ),
}
...
def write_comparison_skeleton() -> Path:
    ...
    lines = [
        "# Anchor 4-way comparison — skeleton, auto-filled",
        "",
